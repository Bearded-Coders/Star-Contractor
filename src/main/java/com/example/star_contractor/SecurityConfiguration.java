...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/profile/edits", "/profile/edit", "/profile/remove/{id}", "/profile/add/{id}", "/jobs/remove/{id}", "/jobs/apply/{id}", "/profile/{id}", "/jobs/{id}", "/jobs/createjob", "/jobs/editjob", "/jobs/editjob/{id}").authenticated()
