...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/jobs/{id}/myjobs", "/jobs/{id}/add-comment", "/jobs/{jobId}/comment/{commentId}/delete").authenticated()
                        ...
                        .requestMatchers("/rate-host", "/rate-host-form", "/rate-applicant", "/rate-applicant-form").authenticated()
